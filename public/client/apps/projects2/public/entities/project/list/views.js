...
define(["app",
    "common/views",
    "tpl!apps/projects/public/entities/project/list/templates/list.tpl",
    "tpl!apps/projects/public/entities/project/list/templates/list_item.tpl",
    "tpl!apps/projects/public/entities/project/list/templates/search_form.tpl",
    "tpl!apps/projects/public/entities/project/list/templates/header.tpl"
],
    function ( IntranetManager, GlobalViews,  listTpl, listItemTpl, searchFormTpl,
        headerTpl) {
        IntranetManager.module("ProjectsManager.Public.Posts.List.Views",
        ...
        return IntranetManager.ProjectsManager.Public.Posts.List.Views;
    });
