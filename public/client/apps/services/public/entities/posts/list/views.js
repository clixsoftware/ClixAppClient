...
define(["app",
    "common/views",
    "tpl!apps/services/public/entities/posts/list/templates/list.tpl",
    "tpl!apps/services/public/entities/posts/list/templates/list_item.tpl",
    "tpl!apps/services/public/entities/posts/list/templates/search_form.tpl",
    "tpl!apps/services/public/entities/posts/list/templates/header.tpl"
],
    function ( IntranetManager, GlobalViews,  listTpl, listItemTpl, searchFormTpl,
        headerTpl) {
        IntranetManager.module("ServicesManager.Public.Posts.List.Views",
        ...
        return IntranetManager.ServicesManager.Public.Posts.List.Views;
    });
