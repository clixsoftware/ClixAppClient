...
<div class="row">
    <div class="col-lg-12"><a
        ...
        <div class="media-body">
            <div><p><span class="listglyph"><i class="glyphicon glyphicon-calendar"></i> <%=moment(start_date).format("DD MMM YYYY")%> &nbsp; -  &nbsp; <%=moment(start_date).format("DD MMM YYYY")%></span></p></div>
            <p><%=obj.description%>… </p>
        </div>
    </div>
</div>
