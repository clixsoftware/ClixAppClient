...
define(["app",
    ...
    "tpl!apps/vacancy/public/entities/posts/list/templates/home.tpl",
    "tpl!apps/vacancy/public/entities/posts/list/templates/list_item.tpl",
    "tpl!apps/vacancy/public/entities/posts/list/templates/list_item_large.tpl",
    "tpl!apps/vacancy/public/entities/posts/list/templates/no_records.tpl",
            ...
            function ( Views, IntranetManager, Backbone, Marionette, $, _ ) {
                ...
                Views.ListItemView = Marionette.ItemView.extend({
                    ...
                    onRender: function(){
                        ...
                        console.group('Render -> vacancy : Lists: Views : NewsListItemView');
                ...
                Views.HomeView = Marionette.CollectionView.extend({
                    ...
                    onBeforeRender: function () {
                        ...
                        $('body').addClass('public vacancy home').removeClass('app');
                ...
                Views.ListView = Marionette.CompositeView.extend({
                    ...
                    onRender: function () {
                        $('body').addClass('page-template-page-vacancy-php');
                        console.info('Rendered : vacancy: List: ListViews');
                    }
                });
                ...
                Views.PaginatedView = Marionette.ItemView.extend({
                    ...
                    onRender: function () {
                        ...
                        console.group('vacancy: List: Views: Paginator');
                        var that = this;
