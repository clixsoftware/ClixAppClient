define([
    "app",
    "tpl!apps/calendar/public/entities/posts/show/templates/public_view.tpl",
    "tpl!apps/calendar/public/entities/posts/show/templates/post_layout.tpl"
],
        ...
        IntranetManager.module("CalendarManager.Public.Posts.Show.Views",
            function ( Views, IntranetManager, Backbone, Marionette, $, _ ) {
                ...
                Views.PostLayoutView = Marionette.LayoutView.extend({
                    ...
                    onRender: function(){
                        console.group('Render -> calendar : Show: Views : PostLayoutView');
                ...
                Views.PublicView = Marionette.ItemView.extend({
                    ...
                    onBeforeRender: function () {
                        // set up final bits just before rendering the view's `el`
                        $('body').addClass('single single-calendar');
                    },
                    ...
                    onRender: function(){
                        ...
                        console.group('Render -> calendar : Show: Views : PublicView');
