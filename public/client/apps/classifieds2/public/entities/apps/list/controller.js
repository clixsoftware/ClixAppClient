...
define([
        "app",
        "apps/classifieds/public/entities/apps/list/views",
    ...
    function ( IntranetManager, ListViews, CommonViews, GlobalViews ) {
        IntranetManager.module("ClassifiedsManager.Public.Apps.List",
                ...
                List.Controller = {
                    ...
                    loadAppsHome: function () {
                        ...
                        require(['entities/applications'], function () {
                            ...
                            var fetchingApps = IntranetManager.request('applications:search:feature', 'classifieds');
        ...
        return IntranetManager.ClassifiedsManager.Public.Apps.List.Controller;
    });
