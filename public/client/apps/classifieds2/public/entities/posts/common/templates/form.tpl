            ...
            <div class="message-content-body">
                <div class="field">
                    <input placeholder="Headline" type="text" id="post_title"
                           name="title" class="no-border" value="<%=obj.title%>">
                </div>

                <div class="field">
                    <textarea class="no-border" id="post_content" name="content"
                              placeholder="Type your content here"> <%=obj
                        .content%></textarea>
                </div>
            </div>
        </div>
                    ...
                    <div class="ui basic segment">
                        <div class="field">
                            ...
                            <input type="text" placeholder="Sports" name="category"
                                   id="post_category" value="<%=obj.category%>">
                        </div>
                        <div class="ui toggle checkbox">
                            <input type="checkbox" name="is_featured"
                                   id="post_is_featured" value="<%=obj.is_featured%>">
                            <label>Set article has Featured</label>
                        </div>
                        <div class="ui toggle checkbox">
                            <input type="checkbox" name="show_on_homepage"
                                   id="post_is_featured" value="<%=obj.show_on_homepage%>">
        ...
        <div class="ui tab segment" data-tab="third">
            <div class="field">
                ...
                <input type="text" placeholder="/assets/images/headlineimage.jpg"
                       name="cover_image"
                       id="post_cover_image" value="<%=obj.cover_image%>">
            </div>
            <div class="field">
                <label>Thumbnail</label>
                <input type="text" placeholder="/assets/images/thumbnail.jpg"
                       name="thumbnail" id="post_thumbnail" value="<%=obj.thumbnail%>">
            </div>
        </div>
                    ...
                    <div class="ui basic segment">
                        <div class="field">
                            ...
                            <input type="text" placeholder="Publish link"
                                   name="short_title"
                                   id="post_short_title" value="<%=obj.short_title%>">
                        </div>
                        <div class="field">
                            <label>Tags</label>
                            <input type="text" placeholder="e.g. nursing"
                                   name="tags" id="post_tags" value="<%=obj.tags%>">
                        </div>
