...
define(["app",
    "common/views",
    "tpl!apps/projects/public/entities/posts/list/templates/layout.tpl",
    "tpl!apps/projects/public/entities/posts/list/templates/home.tpl",
    "tpl!apps/projects/public/entities/posts/list/templates/list_item.tpl",
    "tpl!apps/projects/public/entities/posts/list/templates/list_item_large.tpl",
    "tpl!apps/projects/public/entities/posts/list/templates/no_records.tpl",
    "tpl!apps/projects/public/entities/posts/list/templates/paginator.tpl",
    "tpl!apps/projects/public/entities/posts/list/templates/search_form.tpl",
        "tpl!apps/projects/public/entities/posts/list/templates/header.tpl"
],
    function ( IntranetManager, GlobalViews,  layoutTpl,homeTpl, listItemTpl, listItemLargeTpl,
        ...
        IntranetManager.module("ProjectManager.Public.Posts.List.Views",
            function ( Views, IntranetManager, Backbone, Marionette, $, _ ) {
                ...
                Views.ListItemView = Marionette.ItemView.extend({
                    ...
                    onRender: function(){
                        ...
                        console.group('Render -> projects : Lists: Views : NewsListItemView');
                ...
                Views.HomeView = Marionette.CollectionView.extend({
                    ...
                    onBeforeRender: function () {
                        ...
                        $('body').addClass('public projects home').removeClass('app');
                ...
                Views.ListView = Marionette.CompositeView.extend({
                    ...
                    onRender: function () {
                        $('body').addClass('page-template-page-projects-php');
                        console.info('Rendered : projects: List: ListViews');
                    }
                });
                ...
                Views.PaginatedView = Marionette.ItemView.extend({
                    ...
                    onRender: function () {
                        ...
                        console.group('projects: List: Views: Paginator');
                        var that = this;
        ...
        return IntranetManager.ProjectManager.Public.Posts.List.Views;
    });
