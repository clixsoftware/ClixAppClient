define([
    "app",
    "tpl!apps/projects/public/entities/posts/show/templates/public_view.tpl",
    "tpl!apps/projects/public/entities/posts/show/templates/post_layout.tpl"
],
    function ( IntranetManager,  publicViewTpl, postLayoutTpl ) {

        IntranetManager.module("ProjectManager.Public.Posts.Show.Views",
            function ( Views, IntranetManager, Backbone, Marionette, $, _ ) {
                ...
                Views.PostLayoutView = Marionette.LayoutView.extend({
                    ...
                    onRender: function(){
                        console.group('Render -> projects : Show: Views : PostLayoutView');
                ...
                Views.PublicView = Marionette.ItemView.extend({
                    ...
                    onBeforeRender: function () {
                        // set up final bits just before rendering the view's `el`
                        $('body').addClass('single single-projects');
                    },
                    ...
                    onRender: function(){
                        ...
                        console.group('Render -> projects : Show: Views : PublicView');
        ...
        return IntranetManager.ProjectManager.Public.Posts.Show.Views;
    });
