define([
    ...
    function ( IntranetManager,  publicViewTpl, postLayoutTpl ) {
        ...
        IntranetManager.module("ClassifiedsManager.Public.Posts.Show.Views",
            function ( Views, IntranetManager, Backbone, Marionette, $, _ ) {
                ...
                Views.PostLayoutView = Marionette.LayoutView.extend({
                    ...
                    onRender: function(){
                        console.group('Render -> classifieds : Show: Views : PostLayoutView');
                ...
                Views.PublicView = Marionette.ItemView.extend({
                    ...
                    onRender: function(){
                        ...
                        console.group('Render -> classifieds : Show: Views : PublicView');
        ...
        return IntranetManager.ClassifiedsManager.Public.Posts.Show.Views;
    });
