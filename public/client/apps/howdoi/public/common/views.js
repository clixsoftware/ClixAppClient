...
define([
    "app",
    "common/views",
    "tpl!apps/howdoi/public/common/templates/form.tpl",
    "tpl!apps/howdoi/public/common/templates/app_menu.tpl",
    "tpl!apps/howdoi/public/common/templates/blank.tpl",
    "tpl!apps/howdoi/public/common/templates/blank_help.tpl",
    "tpl!apps/howdoi/public/common/templates/public_layout.tpl"

], function(IntranetManager, GlobalViews, formTpl, appMenuTpl, blankTpl, blankhelpTpl, publicLayoutTpl){

    IntranetManager.module("HowDoIManager.Public.Common.Views",
        function(
             Views,
             IntranetManager,
             Backbone,
  ...
  return IntranetManager.HowDoIManager.Public.Common.Views;
});
