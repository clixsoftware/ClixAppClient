...
define([
    ...
    function ( IntranetManager, ListViews, CommonViews, GlobalViews ) {
        IntranetManager.module("YPManager.Apps.List",
            function ( List, YPManager, Backbone, Marionette, $, _ ) {
                List.Controller = {
                    ...
                    listRecords: function (appId) {
                        ...
                        console.group('YPManager: Apps: listRecords');
                        ...
                        var cb = function () {
                            ...
                            require(["entities/applications"],
                                function () {
                                    ...
                                    var fetchingRecords = IntranetManager.request('applications:search:feature', 'yp');
        ...
        return IntranetManager.YPManager.Apps.List.Controller;
    });
