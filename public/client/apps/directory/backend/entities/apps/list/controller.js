...
define([
    "app",
    "apps/yp/entities/apps/list/views",
    "apps/yp/common/views",
    "common/views"
],
    function ( IntranetManager, ListViews, CommonViews, GlobalViews ) {
        IntranetManager.module("DirectoryManager.Apps.List",
            function ( List, DirectoryManager, Backbone, Marionette, $, _ ) {
                List.Controller = {
                    ...
                    listRecords: function (appId) {
                        ...
                        console.group('DirectoryManager: Apps: listRecords');
                        ...
                        var cb = function () {
                            ...
                            require(["entities/applications"],
                                function () {
                                    ...
                                    var fetchingRecords = IntranetManager.request('applications:search:feature', 'directory');
        ...
        return IntranetManager.DirectoryManager.Apps.List.Controller;
    });
