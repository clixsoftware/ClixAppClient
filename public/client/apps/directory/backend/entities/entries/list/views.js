...
define(["app",
    ...
    function ( IntranetManager, GlobalViews,  blankHelpTpl,  listTpl, listItemTpl, categoriesTpl, publicHomeTpl, publicListItem, publicListCategoryTpl, categoryListItemTpl , sidebarTpl, publicLayoutTpl, searchFormTpl, atozTpl, sortFilterTpl, adminListTpl, adminListItemTpl, paginatorTpl) {
                ...
                Views.PaginatedView = Marionette.ItemView.extend({
                    ...
                    initialize: function() {
                       // _.bindAll(this, 'previous', 'next', 'render');
                        ...
                        this.model.set('pages', this.collection.pageInfo.pages);
                    },
