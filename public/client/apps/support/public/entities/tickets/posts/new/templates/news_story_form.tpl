...
<div class="col-lg-12 col-sm-12 col-md-4 well well-sm">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <label for="support_content"> Story*</label>
                <textarea class="form-control"  name="content" id="support_content"  placeholder="Details of the news story" rows="10" required></textarea>
                <h6 class="pull-right" id="counter">1500 characters remaining</h6>
            </div>
        </div>
     </div>
