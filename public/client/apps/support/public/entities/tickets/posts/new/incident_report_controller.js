define([
    "app",
    "apps/support/public/entities/tickets/posts/new/views",
    "Q",
    "moment"

], function ( IntranetManager, NewViews, Q ) {

    IntranetManager.module("SupportManager.Public.Tickets.Posts.New",
        function ( Show, SupportManager, Backbone, Marionette, $, _ ) {
            ...
            Show.Controller = {
                ...
                getServiceForm: function ( post ) {
                    ...
                    return new NewViews.IncidentReportForm({
                        model: post
                    });
    ...
    return IntranetManager.SupportManager.Public.Tickets.Posts.New.Controller;
});
