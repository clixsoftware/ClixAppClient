...
define(["app",
    "common/views",
    "tpl!apps/support/public/entities/services/posts/list/templates/layout.tpl",
    "tpl!apps/support/public/entities/services/posts/list/templates/home.tpl",
    "tpl!apps/support/public/entities/services/posts/list/templates/list_item.tpl",
    "tpl!apps/support/public/entities/services/posts/list/templates/list_item_large.tpl",
    "tpl!apps/support/public/entities/services/posts/list/templates/no_records.tpl",
    "tpl!apps/support/public/entities/services/posts/list/templates/paginator.tpl",
    "tpl!apps/support/public/entities/services/posts/list/templates/search_form.tpl",
     "tpl!apps/support/public/entities/services/posts/list/templates/header.tpl"
],
    function ( IntranetManager, GlobalViews,  layoutTpl,homeTpl, listItemTpl, listItemLargeTpl,
        ...
        IntranetManager.module("SupportManager.Public.Services.Posts.List.Views",
            function ( Views, IntranetManager, Backbone, Marionette, $, _ ) {
                ...
                Views.ListItemView = Marionette.ItemView.extend({
                    ...
                    onRender: function(){
                        ...
                        console.group('Render -> supports : Lists: Views : NewsListItemView');
                ...
                Views.HomeView = Marionette.CollectionView.extend({
                    ...
                    onBeforeRender: function () {
                        ...
                        $('body').addClass('public supports home').removeClass('app');
                ...
                Views.ListView = Marionette.CompositeView.extend({
                    ...
                    onRender: function () {
                        $('body').addClass('page-template-page-supports-php');
                        console.info('Rendered : supports: List: ListViews');
                    }
                });
                ...
                Views.PaginatedView = Marionette.ItemView.extend({
                    ...
                    onRender: function () {
                        ...
                        console.group('supports: List: Views: Paginator');
                        var that = this;
        ...
        return IntranetManager.SupportManager.Public.Services.Posts.List.Views;
    });
