define([
    "app",
    "tpl!apps/support/public/entities/services/posts/show/templates/public_view.tpl",
    "tpl!apps/support/public/entities/services/posts/show/templates/post_layout.tpl"
],
    function ( IntranetManager,  publicViewTpl, postLayoutTpl ) {

        IntranetManager.module("SupportManager.Public.Services.Posts.Show.Views",
            function ( Views, IntranetManager, Backbone, Marionette, $, _ ) {
                ...
                Views.PostLayoutView = Marionette.LayoutView.extend({
                    ...
                    onRender: function(){
                        console.group('Render -> supports : Show: Views : PostLayoutView');
                ...
                Views.PublicView = Marionette.ItemView.extend({
                    ...
                    onBeforeRender: function () {
                        // set up final bits just before rendering the view's `el`
                        $('body').addClass('single single-supports');
                    },
                    ...
                    onRender: function(){
                        ...
                        console.group('Render -> supports : Show: Views : PublicView');
        ...
        return IntranetManager.SupportManager.Public.Services.Posts.Show.Views;
    });
