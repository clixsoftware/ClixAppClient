define([
        "app",
        "apps/support/public/entities/services/posts/list/views",
    ...
    function (IntranetManager, ListViews, CommonViews, GlobalViews) {
        IntranetManager.module("SupportManager.Public.Services.Posts.List",
            function (List, SupportManager, Backbone, Marionette, $, _) {
                List.Controller = {
                    ...
                    showPostsList: function (opts) {
                        ...
                        console.group('<< supports : List: showPostsList  >>');
                        ...
                        require(['entities/applications', 'entities/support', 'entities/taxonomy', 'entities/core'], function () {
                            ...
                            fetchingApp.then(function (app) {
                                ...
                                var fetchingRecords = IntranetManager.request('support:app:posts:search', options);
                                ...
                                .spread(function (app, fetchedPosts, layout, triggerOptions) {
                                    ...
                                    searchFormView.on("posts:search", function (filterCriterion) {
                                        ...
                                        var search = IntranetManager.request("support:app:posts:search", search_options);

                                        search.then(function (results) {
                                            buildPaginate(results, 'support:app:posts:search', search_options);
                                        });
                                    ...
                                    layout.on('show', function () {
                                        ...
                                        IntranetManager.trigger('core:object:categories', {
                                            ...
                                            url: '/support/' + opts.alias +  '/posts-by-category/{{slug}}?uuid={{uuid}}',
                                            urlTrigger: "support:category:posts"
                                        });

                                        IntranetManager.trigger('core:object:tags', {
                                            collection:  app.get('taxonomy'),
                                            url: '/support/'  + opts.alias +  '/posts-by-tag/{{slug}}'
                                        });
                                        ...
                                        if(triggerOptions.categories) {
                                            ...
                                            fetchingTaxonomy.then(function (category) {
                                                ...
                                                updateTitles("services by category :: " + category.get('title'), null);

                                            });

                                        }else if (triggerOptions.tag){

                                            var tagModel = IntranetManager.request('core:new:entity', {title: 'All services tagged : ' + triggerOptions.tag});
                                            updateTitles("All services tagged : : " + triggerOptions.tag, null);
                                        ...
                                        buildPaginate(fetchedPosts, 'support:app:posts:search', triggerOptions);
        ...
        return IntranetManager.SupportManager.Public.Services.Posts.List.Controller;
    });
