...
define([
    ...
    function (IntranetManager, CommonViews, GlobalViews) {
        IntranetManager.module("PageManager.Public.Common",
            function (Common, PageManager, Backbone, Marionette, $, _) {
                ...
                Common.Controller = {
                    ...
                    initAppEngine: function (next) {
                        ...
                        console.log('<< initAppEngine:  (PageManager)  >>');
                   /*     if (ProjectsManager.started === false || ProjectsManager.started === undefined) {*/
                        ...
                        require(["entities/feature"],
                            function () {
                                ...
                                //fetch feature
                                var fetchFeature = IntranetManager.request('feature:entity:search:alias', 'pages');

                                fetchFeature.then(function (feature) {

                                    if (!feature) {
                                        throw new Error('The feature PageManager is not installed, or the API is down.');
                                    }
                                   ...
                                   // IntranetManager.siteMainContent.reset();
                                    ...
                                    .fail(function (error) {
                                        console.log('!!! Error starting - PageManager App ' + error);
                                    });
...
/*                        } else {
        ...
        return IntranetManager.PageManager.Public.Common.Controller;
    });
